        ...
        #box(
          ...
          [
            #table(
              ...
              table.cell([*(#encabezado_100)*]),
              table.cell([*(#encabezado_porcion)*]),

              table.cell(align: left, [*Totales*]),
              table.cell([#(producto.nutricion.calorias_100)]),
              table.cell([#(producto.nutricion.calorias_porcion)]),

              table.cell(align: left, [*Calorías de grasa*]),
              table.cell([#(producto.nutricion.calorias_grasa_100)]),
        ...
        #box(
          ...
          [
            #table(
              ...
              table.cell([*Proteína*]),
              table.cell([#(producto.nutricion.proteina_100)]),
              table.cell([#(producto.nutricion.proteina_porcion)]),

              table.cell([*Sodio*]),
              table.cell([#(producto.nutricion.sodio_100)]),
              table.cell([#(producto.nutricion.sodio_porcion)]),

              table.cell([*Colesterol*]),
              table.cell([#(producto.nutricion.colesterol_100)]),
